...
- Season creation form hides: pairing mode, odd player rule, courts for rivalry groups
- Keeps: sets per match (1 or 3), season type, round dates, time, retroactive toggle
