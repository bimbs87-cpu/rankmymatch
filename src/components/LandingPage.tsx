      ...
      <section className="relative z-10">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 pb-16 pt-6 sm:px-8 lg:grid-cols-12 lg:gap-10 lg:pb-20 lg:pt-10">
          ...
          <div className="relative lg:col-span-7">
            ...
            <div className="absolute left-0 top-[60px] z-20 hidden max-w-[260px] rounded-xl border border-border/70 bg-card/90 p-4 shadow-2xl shadow-primary/15 backdrop-blur-2xl lg:block">
