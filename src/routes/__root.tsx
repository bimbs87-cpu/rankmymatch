...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "RankMyMatch — Rankings de Padel" },
      { name: "description", content: "O app definitivo para feirinos com rankings, temporadas de padel entre amigos e clubes." },
      { property: "og:title", content: "RankMyMatch" },
      { property: "og:description", content: "Rankings, temporadas de padel entre amigos e clubes." },
