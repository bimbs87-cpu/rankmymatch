...
function LoginPage() {
  ...
  const GoogleButton = (
    <button
      ...
      disabled={loading}
      className="flex w-full items-center justify-center gap-3 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/90 active:scale-[0.98] disabled:opacity-60 shadow-lg shadow-primary/20 sm:py-4"
    >
  ...
  return (
    <div className="relative min-h-[100dvh] w-full overflow-x-hidden bg-background text-foreground lg:h-screen lg:overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-[100dvh] w-full max-w-6xl flex-col px-5 py-4 sm:px-6 sm:py-6 lg:grid lg:h-full lg:min-h-0 lg:grid-cols-[1.1fr_1fr] lg:items-center lg:gap-16 lg:px-12 lg:py-10">
        ...
        {/* === RIGHT / BOTTOM — CTA === */}
        <div className="mt-3 lg:mt-0 lg:pt-0">
          <div className="relative rounded-3xl border border-border/70 bg-card/50 p-3 backdrop-blur-xl shadow-[0_8px_40px_-12px_rgba(0,0,0,0.5)] sm:p-6 lg:p-8">
            {/* top accent line */}
            <div
              aria-hidden
