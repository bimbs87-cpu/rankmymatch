    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 pb-12">
        ...
        <div className="mb-8 flex flex-col items-center">
          <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-3xl bg-primary shadow-lg shadow-primary/25">
        ...
        <div className="w-full max-w-sm space-y-4">
          <Button
            ...
            disabled={loading}
            className="w-full gap-3 rounded-2xl py-6 text-base font-semibold shadow-lg shadow-primary/20"
            size="lg"
          >
